...
public class MetodoOFuncion2Version3 {

	public static void main(String[] args) {
		new MetodoOFuncion2Version3().calcularRaicesCuadraticas(); //LLamada del metodo
		new MetodoOFuncion2Version3().calcularRaicesCuadraticas();
